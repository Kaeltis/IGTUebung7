...
public class WebserviceSearch {
    ...
    private static String filterStopwords(String text, String[] stopwords) {
        String output = text;
    ...
    public static List<String> findAPIs(String search) throws IOException {
        ...
        System.out.print("Task - " + search);

        if (titles.size() == 0)
            System.out.println("\n\tNothing found :(\n");
        else
            System.out.println(" - (" + titles.size() + " APIs found)");
